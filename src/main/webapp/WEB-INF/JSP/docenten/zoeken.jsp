...
<html lang='nl'>
	...
	<body>
		...
		<c:if test='${not empty docent}'>
			...
			<!-- Je spreekt voor het eerst de bijnamen van de docent aan. JPA leest dan die bijnamen met een select opdracht naar de table docentenbijnamen -->
